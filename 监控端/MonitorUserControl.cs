    ...
    public partial class MonitorUserControl : UserControl
    {
        ...
        public void Initialize(string remoteMachine)
        {
            try
            {
                ...
                robj = (Monitor)Activator.GetObject(typeof(Monitor), "tcp://" + remoteMachine + ":9000/MonitorServerUrl");
        ...
        private void MonitorUserControl_MouseMove(object sender, MouseEventArgs e)
        {
            if (Control)
            {
                ...
                File.AppendAllText(@"D:\AAA\MouseMove.txt", e.X + "," + e.Y + "\r\n");
        ...
        public void UpdateDisplay()
        {
            ...
            try
            {
                ...
                if (BitmapBytes.Length > 0)
                {
                    ...
                    if (!Directory.Exists(@"D:\AAA"))
                        Directory.CreateDirectory(@"D:\AAA");
                    File.AppendAllText(@"D:\AAA\test.txt", P.ToString() + "\r\n");
